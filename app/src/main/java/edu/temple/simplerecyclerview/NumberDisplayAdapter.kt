...
class NumberDisplayAdapter (private val _numbers: Array<Int>, _lambda : (TextView) -> Unit) : RecyclerView.Adapter<NumberDisplayAdapter.NumberViewHolder>() {
    ...
    inner class NumberViewHolder (layout: View) : RecyclerView.ViewHolder (layout) {
        ...
        init{
            textView.setOnClickListener { lambda (textView)}
        }
